...
const Blog = ({ blog, handleBookmarks, bookmarks, handleReadTime }) => {
    const { id, title, featuredImage, authorImage, authorName, postDate, readingTime, hashtags } = blog;
    ...
    return (
        <div className='mb-10 space-y-5'>
            ...
            <button className='text-[#6047EC] underline font-semibold' onClick={() => handleReadTime(id,readingTime)}>Mark as read</button>
        </div>
    );
};
